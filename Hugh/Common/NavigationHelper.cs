...
namespace Hugh.Common
{
    ...
    public class NavigationHelper : DependencyObject
    {
            ...
            Windows.UI.Core.AcceleratorKeyEventArgs e)
        {
            ...
            // are pressed
            if ((e.EventType == Windows.UI.Core.CoreAcceleratorKeyEventType.SystemKeyDown ||
                e.EventType == Windows.UI.Core.CoreAcceleratorKeyEventType.KeyDown) &&
                (virtualKey == Windows.System.VirtualKey.Left || virtualKey == Windows.System.VirtualKey.Right ||
                (int)virtualKey == 166 || (int)virtualKey == 167))
            {
                var coreWindow = Window.Current.CoreWindow;
                var downState = Windows.UI.Core.CoreVirtualKeyStates.Down;
                bool menuKey = (coreWindow.GetKeyState(Windows.System.VirtualKey.Menu) & downState) == downState;
                bool controlKey = (coreWindow.GetKeyState(Windows.System.VirtualKey.Control) & downState) == downState;
                bool shiftKey = (coreWindow.GetKeyState(Windows.System.VirtualKey.Shift) & downState) == downState;
                bool noModifiers = !menuKey && !controlKey && !shiftKey;
                bool onlyAlt = menuKey && !controlKey && !shiftKey;

                if (((int)virtualKey == 166 && noModifiers) ||
                    (virtualKey == Windows.System.VirtualKey.Left && onlyAlt))
                {
                    ...
                    (virtualKey == Windows.System.VirtualKey.Right && onlyAlt))
                {
